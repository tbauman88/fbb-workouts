...
const ExerciseTitle: React.FC<{
  ...
  return (
    <div onClick={onClick} className="cursor-pointer rounded-sm flex-grow">
      <h4
        className="text-base lg:text-lg text-gray-900 font-light cursor-pointer rounded-sm flex-grow mb-2"
