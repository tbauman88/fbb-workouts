...
export const ProgramCard: React.FC<ProgramCardProps> = ({ image, title, description, onClick, children }) => (
  <article className="overflow-hidden rounded-lg bg-white shadow">
    ...
    >
      <img alt="" src={image} className="pointer-events-none w-full h-full object-cover group-hover:opacity-75" />
    </section>

    <div className="px-4 py-4 sm:px-6">
      <h3 onClick={onClick} className="group cursor-pointer text-base font-semibold leading-6 text-gray-900 uppercase">
        {title}
      </h3>
